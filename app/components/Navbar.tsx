...
export default function Navbar() {
  ...
  // Use fixed positioning so the Navbar stays on top even when imported per-page.
  // Add a spacer div after the nav to avoid covering page content.
  return (
    <>
      <nav className='border-b border-gray-800 bg-black/80 backdrop-blur-sm fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between'>
      ...
      {/* Spacer: same height as the nav to prevent content from being hidden underneath */}
      <div className='h-16' />
    </>
  )
}
